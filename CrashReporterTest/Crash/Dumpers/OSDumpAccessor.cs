namespace RJCP.Diagnostics.Crash.Dumpers
{
    ...
    public class OSDumpAccessor : AccessorBase, ICrashDataExport
    {
        private const string AssemblyName = "RJCP.Diagnostics.CrashReporter";
        private const string TypeName = "RJCP.Diagnostics.Crash.Dumpers.OSDump";
        public static readonly PrivateType AccType = new(AssemblyName, TypeName);

        public OSDumpAccessor() : base(AccType) { }
